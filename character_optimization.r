...
evaluateBuild = function(build, options=list(), level=NULL, levels_to_evaluate=NULL){
  ...
  if(!is.null(options$feat_multiplier)){
    multiplier = (num_feats * options$feat_multiplier)
...
blank_prefix_build = list(class = rep(NA, 30),
                          ...
                          weapon = list(name="Kukri",
                                        damage=g_aveDamageDice(1, 4),
                                        size="Light",
                                        hands="Two-Weapon",
                                        damage_type="Slashing",
                                        enhancement_bonus=4,
                                        attack_bonus=0),
                          stats=list("Strength"=18,
                                     "Dexterity"=13,
                                     "Constitution"=10,
                                     "Intelligence"=13,
                                     "Wisdom"=10,
...
options=list(allow_burst=T,
             ...
             feat_multiplier=0.15)
avail_classes = list("Monk"=0, "Dervish"=10, "Invisible Blade"=5, "Fighter"=0, "Swashbuckler"=0, "Tempest"=5, "Ranger"=30)
